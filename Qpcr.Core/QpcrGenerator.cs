        ...
        public List<CellItem> GenerateQpcr(QpcrModel model)
        {
            ...
            for (int dimensionIndex = 0; dimensionIndex < model.Names.Rank; dimensionIndex++)
            {
                ...
                for (int itemIndex = 0; itemIndex < model.Names.GetLength(dimensionIndex); itemIndex++)
                {
                    ...
                    {
                        for (int listOfIntegerItem = 0; listOfIntegerItem < model.listOfIntegers[listOfIntegerLen]; listOfIntegerItem++)
                        {
            ...
            if (model.PlateSize == Constants.PLATESIZE_96)
            {
                rowCount = 8;
                columnCount = 16;
            }
           ...
           GenerateVisualTable(cellItems,rowCount,columnCount);
